...
class BinanceAPI:
    BASE_URL = "https://www.binance_api.com/api/v1"
    BASE_URL_V3 = "https://api.binance_api.com/api/v3"
    PUBLIC_URL = "https://www.binance_api.com/exchange/public/product"

    def __init__(self, key, secret, recv_window=5000):
        self.key = key
        self.secret = secret
